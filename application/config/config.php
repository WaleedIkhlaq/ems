<?php
    ...
    |
    */
    $config[ 'base_url' ] = 'http://ems.erpsirius.net/';
    ...
    */
    ...
    |
    */
    $config[ 'encryption_key' ] = '4J?4A#@QP=x9*T=2';
    ...
    */
    ...
    $config[ 'csrf_token_name' ] = 'csrf_ems_token';
    $config[ 'csrf_cookie_name' ] = 'csrf_ems_cookie';
