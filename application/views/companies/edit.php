    ...
    <div class="row">
        <div class="col-12 col-md-12 col-lg-12">
            ...
            <div class="card">
                ...
                <form method="post">
                    <?php csrf_field (); ?>
                    <?php hidden_action_field ( 'process-update-companies' ); ?>
                    <input type="hidden" name="id" value="<?php echo encrypt_string ( $company -> id ) ?>">
                    <div class="card-body pb-0">
                        <div class="row">
                            <div class="form-group col-lg-12">
                                <label>Title</label>
                                <input type="text" placeholder="Title" required="required" autofocus="autofocus"
                                       class="form-control" name="title" value="<?php echo $company -> title ?>">
                            </div>
                        </div>
                            ...
                            <div class="col-lg-12 form-group">
                                <ul class="shifts-list">
                                    <?php
                                        ...
                                        if ( count ( $unSelectedShifts ) > 0 ) {
                                            foreach ( $unSelectedShifts as $key => $shift ) {
                                                ?>
                                                <li>
                                                    <div class="custom-control custom-checkbox">
                                                        <input type="checkbox" class="custom-control-input"
