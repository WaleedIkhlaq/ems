<div class="card">
    ...
    <form method="get">
        <div class="card-body pb-0">
            <div class="row">
                <div class="form-group offset-1 col-lg-3">
                    <label>Company</label>
                ...
                <div class="form-group col-lg-2"><label>Attendance Date</label>
                    <input type="text" name="attendance-date" class="form-control datepicker"
                           data-date-format="yyyy-mm-dd"
                           value="<?php echo $this -> input -> get ( 'attendance-date' ) ?>">
                </div>
