                    ...
                    <table class="table table-striped">
                            ...
                            <td class="text-truncate">
                                <ul class="list-unstyled order-list m-b-0 m-b-0">
                                    <li class="team-member team-member-sm"><img class="rounded-circle"
                                                                                src="<?php echo base_url ( '/assets/img/users/user-8.png' ); ?>"
                                                                                alt="user"
                                                                                data-toggle="tooltip"
                                                                                title=""
                                    ...
                                    <li class="team-member team-member-sm"><img class="rounded-circle"
                                                                                src="<?php echo base_url ( '/assets/img/users/user-9.png' ); ?>"
                                                                                alt="user"
                                                                                data-toggle="tooltip"
                                                                                title=""
                                    ...
                                    <li class="team-member team-member-sm"><img class="rounded-circle"
                                                                                src="<?php echo base_url ( '/assets/img/users/user-10.png' ); ?>"
                                                                                alt="user"
                                                                                data-toggle="tooltip"
                                                                                title=""
                        ...
                        <tr>
                            ...
                            <td class="text-truncate">
                                <ul class="list-unstyled order-list m-b-0 m-b-0">
                                    <li class="team-member team-member-sm"><img class="rounded-circle"
                                                                                src="<?php echo base_url ( '/assets/img/users/user-1.png' ); ?>"
                                                                                alt="user"
                                                                                data-toggle="tooltip"
                                                                                title=""
                                                                                data-original-title="Wildan Ahdian">
                                    ...
                                    <li class="team-member team-member-sm"><img class="rounded-circle"
                                                                                src="<?php echo base_url ( '/assets/img/users/user-2.png' ); ?>"
                                                                                alt="user"
                                                                                data-toggle="tooltip"
                                                                                title=""
                                                                                data-original-title="John Deo">
                        ...
                        <tr>
                            ...
                            <td class="text-truncate">
                                <ul class="list-unstyled order-list m-b-0 m-b-0">
                                    <li class="team-member team-member-sm"><img class="rounded-circle"
                                                                                src="<?php echo base_url ( '/assets/img/users/user-3.png' ); ?>"
                                                                                alt="user"
                                                                                data-toggle="tooltip"
                                                                                title=""
                                                                                data-original-title="Wildan Ahdian">
                                    ...
                                    <li class="team-member team-member-sm"><img class="rounded-circle"
                                                                                src="<?php echo base_url ( '/assets/img/users/user-4.png' ); ?>"
                                                                                alt="user"
                                                                                data-toggle="tooltip"
                                                                                title=""
                                                                                data-original-title="John Deo">
                                    ...
                                    <li class="team-member team-member-sm"><img class="rounded-circle"
                                                                                src="<?php echo base_url ( '/assets/img/users/user-5.png' ); ?>"
                                                                                alt="user"
                                                                                data-toggle="tooltip"
                                                                                title=""
                                                                                data-original-title="Sarah Smith">
                        ...
                        <tr>
                            ...
                            <td class="text-truncate">
                                <ul class="list-unstyled order-list m-b-0 m-b-0">
                                    <li class="team-member team-member-sm"><img class="rounded-circle"
                                                                                src="<?php echo base_url ( '/assets/img/users/user-7.png' ); ?>"
                                                                                alt="user"
                                                                                data-toggle="tooltip"
                                                                                title=""
                                                                                data-original-title="John Deo">
